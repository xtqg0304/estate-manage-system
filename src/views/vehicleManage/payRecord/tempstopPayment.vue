...
export default {
  ...
  methods: {
    ...
    /* 导出 */
    handleDownload() {
      const url = `http://${window.location.host}/api/payment/dataStatistics/exportChargeReportInfo?currentPage=${this.listQuery.currentPage}&pageSize=${this.listQuery.pageSize}&transactionMark=${this.listQuery.transactionMark}&payType=${this.listQuery.payType}&beginTime=${this.listQuery.beginTime}&endTime=${this.listQuery.endTime}&communityId=${this.listQuery.communityId}&searchType=${this.listQuery.searchType}`
