<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :key="tableKey" :data="list" border fit highlight-current-row style="width: 100%;min-height:500px;">
      ...
      <el-table-column label="车牌" min-width="110px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="入场通道" align="center" width="95">
        <template slot-scope="scope">
          <span>{{ scope.row.payAmount }}</span>
        </template>
      </el-table-column>
      <el-table-column label="收费员" class-name="status-col" width="100">
        <template slot-scope="scope">
