...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      this.listQuery.inOutTimeBegin = this.listQuery.inOutTimeBegin && parseTime(this.listQuery.inOutTimeBegin)
      this.listQuery.inOutTimeEnd = this.listQuery.inOutTimeEnd && parseTime(this.listQuery.inOutTimeEnd)
