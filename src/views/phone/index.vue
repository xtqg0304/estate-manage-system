<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.statusservice" placeholder="服务类型" clearable class="filter-item">
        <el-option v-for="item in statusserviceOptions" :key="item" :label="$t('table.'+item)" :value="item" />
      </el-select>
    ...
    <el-table v-loading="listLoading" :key="tableKey" :data="list" border fit highlight-current-row style="width: 100%;min-height:500px;">
      ...
      <el-table-column :label="$t('table.servicename')" width="120px">
        <template slot-scope="scope">
          <span>{{ scope.row.servicename }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.servicephone')" width="120px">
        <template slot-scope="scope">
          <span>{{ scope.row.servicephone }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.remarks')" min-width="150px" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('table.statusservice')" prop="statusservice">
          <el-select v-model="temp.statusservice" class="filter-item" placeholder="请选择">
            <el-option v-for="item in statusserviceOptions" :key="item" :label="$t('table.'+item)" :value="item" />
          </el-select>
        </el-form-item>
        <el-form-item :label="$t('table.servicename')" prop="servicename">
          <el-input v-model="temp.servicename" />
        </el-form-item>
        <el-form-item :label="$t('table.servicephone')" prop="servicephone">
          <el-input v-model="temp.servicephone" />
        </el-form-item>
        <el-form-item :label="$t('table.remarks')" prop="remarks" style="width:650px;">
